...
func (in *SyncthingClusterSpec) DeepCopyInto(out *SyncthingClusterSpec) {
	*out = *in
	...
	if in.Devices != nil {
		...
		*out = make(map[string]SyncthingClusterSpecDevice, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncthingClusterSpecDevice) DeepCopyInto(out *SyncthingClusterSpecDevice) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncthingClusterSpecDevice.
func (in *SyncthingClusterSpecDevice) DeepCopy() *SyncthingClusterSpecDevice {
	if in == nil {
		return nil
	}
	out := new(SyncthingClusterSpecDevice)
	in.DeepCopyInto(out)
	return out
}
